      ...
      <div className="hidden md:flex flex-col">
        <div className="flex flex-col-reverse slg:flex-row w-full gap-[40px] slg:gap-[15px] xxlg:gap-[30px] pt-[100px] px-[20px] sm:px-[50px] md:px-[60px] xxlg:px-[100px]">
          <div className="w-full flex justify-center">
            {/* <Phone1 /> */}
            <div
              className={`w-full hidden slg:flex bg-contain h-[716px] bg-no-repeat p-0 pb-[calc(100% * 3 / 4)] bg-center phone1`}
            />

            <div
              className={`w-full bg-contain flex slg:hidden h-[423px] bg-no-repeat p-0 pb-[calc(100% * 3 / 4)] bg-center image1`}
            />
          </div>

          <div className="w-full flex flex-col gap-[22px] justify-center">
            <p className="text-[40px] font-bold text-[#002616]">
              Laundry Preferences
            </p>
            <p className="text-[24px] text-[#203129]">
              Choose your laundry preference in our app - Wash & Fold or Wash,
              Iron and Fold for complete convenience!
            </p>
          </div>
        </div>
        ...
        <div>
          <div className="flex flex-col slg:flex-row w-full gap-[40px] slg:gap-[15px] xxlg:gap-[30px] pt-[100px] px-[20px] sm:px-[50px] md:px-[60px] xxlg:px-[100px]">
            <div className="w-full flex flex-col gap-[22px] justify-center">
              <p className="text-[40px] font-bold text-[#002616]">
                Personalize Your Plate: Meal Choices at Your Fingertips!
              </p>
              <p className="text-[24px] text-[#203129]">
                Tailor your meals in our app - regular, bowl, or special diets,
                ordered monthly, weekly, or as a one-off treat!
              </p>
            </div>
            ...
            <div className="w-full flex justify-center">
              {/* <Phone2 /> */}
              <div
                className={`w-full bg-contain hidden slg:flex h-[716px] bg-no-repeat p-0 pb-[calc(100% * 3 / 4)] bg-center phone2`}
              />

              <div
                className={`w-full flex slg:hidden bg-contain h-[423px] bg-no-repeat p-0 pb-[calc(100% * 3 / 4)] bg-center image2`}
              />
            </div>
          </div>
        </div>
      ...
      <div className="flex md:hidden flex-col pt-[100px] gap-[80px]">
        <div className="flex flex-col w-full gap-[80px]">
          ...
          <div className="w-full flex flex-col gap-[22px] justify-center px-[24px]">
            <p className="text-[24px] sm:text-[32px] font-bold text-[#002616]">
              Laundry Preferences
            </p>
            <p className="text-[16px] sm:text-[20px] text-[#203129]">
              Choose your laundry preference in our app - Wash & Fold or Wash,
              Iron and Fold for complete convenience!
            </p>
          </div>
